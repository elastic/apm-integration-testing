...
<<<<<<< HEAD
[![Build Status](https://apm-ci.elastic.co/buildStatus/icon?job=apm-integration-tests%2F6.x)](https://apm-ci.elastic.co/job/apm-integration-tests/job/6.x/)
=======
...
>>>>>>> 601121d (action: use GitHub actions (backport #1533) (#1534))
