...
docker run --rm --network apm-integration-testing docker.elastic.co/apm/apm-server:6.7.0-SNAPSHOT apm-server setup --template -e -E setup.template.pattern='apm-6.x*' -E setup.template.name=apm-6.x
